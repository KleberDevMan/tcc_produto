...
class IdeasTest < ApplicationSystemTestCase
  ...
  test "creating a Idea" do
    ...
    fill_in "Idea category", with: @idea.idea_category_id
    check "Possibility business" if @idea.possibility_business
    check "Possibility reward" if @idea.possibility_reward
    fill_in "Status", with: @idea.status
